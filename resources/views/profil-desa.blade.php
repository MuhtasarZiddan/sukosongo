...
<div class="mt-8 mb-14 reveal max-w-6xl mx-auto">
    ...
    <section class="relative py-20 lg:py-28 overflow-hidden">
        ...
        <div class="absolute inset-0 bg-cover bg-center scale-110"
            style="background-image: url('{{ asset('images/profil-desa/kantordesa.jpg') }}'); filter: blur(6px);"></div>
        ...
        <div class="relative max-w-6xl mx-auto px-5 lg:px-8">
            <div class="reveal text-center max-w-2xl mx-auto mb-14">
                <p class="uppercase tracking-[0.2em] text-[color:var(--gold-light)] text-xs font-semibold mb-3">Arah
                    Pembangunan</p>
                <h2 class="font-display text-3xl lg:text-4xl font-semibold text-[color:var(--forest)]">Visi &amp; Misi
                    Desa</h2>
            </div>
            <div class="grid lg:grid-cols-2 gap-6">
                ...
                <div class="reveal bg-[color:var(--forest)] border border-white/10 rounded-2xl p-8 lg:p-10">
                    <div class="flex items-center gap-3 mb-6">
                        <div
                            class="w-10 h-10 rounded-full bg-[color:var(--gold)] flex items-center justify-center font-display font-semibold text-[color:var(--forest)] text-sm shrink-0">
                            V
                        </div>
                ...
                {{-- MISI --}}
                <div
                    class="reveal bg-[color:var(--forest)]  border-white/10bg-white/5 border-white/10 rounded-2xl p-8 lg:p-10">
                    <div class="flex items-center gap-3 mb-6">
                        <div
                            class="w-10 h-10 rounded-full bg-[color:var(--gold)] flex items-center justify-center font-display font-semibold text-[color:var(--forest)] text-sm shrink-0">
                            M
                    ...
                    <ul class="space-y-4">
                        @foreach ($misi as $i => $item)
                            <li class="flex gap-3">
                                <span
                                    class="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center text-[color:var(--gold-light)] text-xs font-semibold shrink-0">
                                    {{ $i + 1 }}
                                </span>
    ...
    <section class="bg-[color:var(--paper)] py-20 lg:py-28">
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
            <div class="reveal max-w-xl mb-14">
                <p class="uppercase tracking-[0.2em] text-[color:var(--brown)] text-xs font-semibold mb-3">Sumber Daya
                </p>
                <h2 class="font-display text-3xl lg:text-4xl font-semibold text-[color:var(--forest)]">Potensi Desa
                    Sukosongo</h2>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="potensi-card reveal sm:col-span-2 lg:col-span-1 lg:row-span-2 rounded-2xl overflow-hidden relative min-h-[320px] flex flex-col justify-end p-7 bg-cover bg-center"
                    style="background-image: url('{{ asset('images/profil-desa/pertanian.jpg') }}');">
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-[color:var(--forest)] via-[color:var(--forest)]/60 to-transparent">
                    </div>

                    <div class="relative">
                        <p class="text-[color:var(--gold-light)] text-xs uppercase tracking-wide font-semibold mb-2">
                            Unggulan</p>
                ...
                <div class="potensi-card reveal potensi-bg-slider rounded-2xl min-h-[240px] flex flex-col justify-end p-6"
                    data-slider>
                    <div class="bg-slide active"
                        style="background-image: url('{{ asset('images/profil-desa/irigasi.png') }}');"></div>
                    <div class="bg-slide"
                        style="background-image: url('{{ asset('images/profil-desa/pertanian.jpg') }}');"></div>

                    <div
                        class="absolute inset-0 bg-gradient-to-t from-[color:var(--forest)] via-[color:var(--forest)]/50 to-transparent">
                    </div>
                    <div class="relative">
                ...
                <div class="potensi-card reveal potensi-bg-slider rounded-2xl min-h-[240px] flex flex-col justify-end p-6"
                    data-slider>
                    <div class="bg-slide active"
                        style="background-image: url('{{ asset('images/profil-desa/hasil1.jpg') }}');"></div>
                    <div class="bg-slide"
                        style="background-image: url('{{ asset('images/profil-desa/hasil2.jpg') }}');"></div>
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-[color:var(--forest)] via-[color:var(--forest)]/50 to-transparent">
                    </div>
                    <div class="relative">
                        <h3 class="font-display font-semibold text-lg text-white mb-2">Hasil Pertanian Desa Sukosongo
                        </h3>
                        <p class="text-sm text-white/70 leading-relaxed">
                ...
                <div class="potensi-card reveal potensi-bg-slider rounded-2xl min-h-[240px] flex flex-col justify-end p-6"
                    data-slider>
                    <div class="bg-slide active"
                        style="background-image: url('{{ asset('images/profil-desa/pekarangan1.jpg') }}');"></div>
                    <div class="bg-slide"
                        style="background-image: url('{{ asset('images/profil-desa/pekarangan2.jpg') }}');"></div>
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-[color:var(--forest)] via-[color:var(--forest)]/50 to-transparent">
                    </div>
                    <div class="relative">
                        <h3 class="font-display font-semibold text-lg text-white mb-2">Pekarangan Warga Desa Sukosongo
                        </h3>
                        <p class="text-sm text-white/70 leading-relaxed">
                ...
                <div class="potensi-card reveal potensi-bg-slider rounded-2xl min-h-[240px] flex flex-col justify-end p-6"
                    data-slider>
                    <div class="bg-slide active"
                        style="background-image: url('{{ asset('images/profil-desa/padi2.jpg') }}');"></div>
                    <div class="bg-slide"
                        style="background-image: url('{{ asset('images/profil-desa/padi1.jpg') }}');"></div>
                    <div
                        class="absolute inset-0 bg-gradient-to-t from-[color:var(--forest)] via-[color:var(--forest)]/50 to-transparent">
                    </div>
                    <div class="relative">
