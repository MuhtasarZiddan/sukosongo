...
<body class="antialiased">
            ...
            <div class="grid lg:grid-cols-2 gap-14 items-center">
               ...
               [transform-style:preserve-3d]">
                            ...
                            <div class="absolute inset-0 rounded-2xl overflow-hidden [backface-visibility:hidden]">
                                <img src="{{ asset('images/profil-desa/kantordesa.webp') }}"
                   ...
                   [backface-visibility:hidden]">
                                ...
                                <img src="{{ asset('images/profil-desa/hasil1.webp') }}"
                                    class="w-full h-full object-cover">
                            </div>
               ...
               [transform-style:preserve-3d]">
                            ...
                            <div class="absolute inset-0 rounded-2xl overflow-hidden [backface-visibility:hidden]">
                                ...
                                <img src="{{ asset('images/profil-desa/padi1.webp') }}"
                                    class="w-full h-full object-cover">
                   ...
                   [backface-visibility:hidden]">
                                ...
                                <img src="{{ asset('images/profil-desa/pertanian.webp') }}"
                                    class="w-full h-full object-cover">
                            </div>
                        </div>
                    </div>
    ...
    @php
        $dusun = [
            ...
            ['nama' => 'Dusun Sukolilo', 'gambar' => 'pesarean.webp'],
        ];
    @endphp
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
            @foreach ($dusun as $item)
                <div
                    ...
                    {{-- FOTO --}}
                    <img src="{{ asset('images/profil-desa/' . $item['gambar']) }}" alt="{{ $item['nama'] }}"
                    ...
                    {{-- NAMA --}}
                    <div
                        class="absolute bottom-0 left-0 right-0 p-5 transition-all duration-500 group-hover:-translate-y-1">
                        <div class="flex items-center gap-2">

                            {{-- ICON --}}
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-[#E4C46C] shrink-0"
