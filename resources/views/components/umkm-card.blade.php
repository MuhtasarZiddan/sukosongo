...
<div
    class="umkm-card bg-white rounded-2xl overflow-hidden border-2 border-transparent shadow-sm hover:shadow-lg hover:border-[color:var(--forest)] transition-all flex flex-col"
...
>
    ...
    <div class="p-6 flex flex-col flex-1">
        ...
        <div class="flex items-center gap-2 mb-1">
            <svg class="w-4 h-4 text-[color:var(--forest)]"
                fill="none"
                stroke="currentColor"
                stroke-width="2"
                viewBox="0 0 24 24">
        ...
        <a
            ...
            class="flex items-center justify-center gap-2 w-full bg-[color:var(--forest)] hover:bg-[color:var(--forest-light)] text-white font-semibold text-sm py-3 rounded-full transition-colors"
        >
