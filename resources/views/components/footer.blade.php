    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-8">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm text-white/60">
                    <li><a href="mailto:desasukosongo@gmail.com" class="hover:text-white transition-colors">desasukosongo@gmail.com</a></li>
                    <li><a href="https://wa.me/6281234567890" target="_blank" class="hover:text-white transition-colors">+62 812-3456-7890</a></li>
                </ul>
                ...
                <div class="flex items-center gap-3 mt-5">
                    <a href="https://instagram.com/sukosongodesa" target="_blank"
                       class="w-10 h-10 rounded-full bg-white/10 hover:bg-[color:var(--gold)] transition-all duration-300 flex items-center justify-center group">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-white group-hover:text-[color:var(--forest)]">
                            <path d="M7.75 2C4.574 2 2 4.574 2 7.75v8.5C2 19.426 4.574 22 7.75 22h8.5C19.426 22 22 19.426 22 16.25v-8.5C22 4.574 19.426 2 16.25 2h-8.5ZM12 7.5A4.5 4.5 0 1 1 7.5 12 4.505 4.505 0 0 1 12 7.5Zm5.25-.75a.75.75 0 1 1-.75-.75.75.75 0 0 1 .75.75ZM12 9a3 3 0 1 0 3 3 3.003 3.003 0 0 0-3-3Z"/>
                        </svg>
                    </a>
