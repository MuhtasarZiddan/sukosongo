...
<body class="antialiased">
    ...
    <section id="beranda"
        ...
        <div
            class="relative max-w-7xl mx-auto px-5 lg:px-8 max-w-3xl mx-auto flex flex-col items-center gap-12 items-center">
    ...
    <section id="struktur" class="bg-[color:var(--paper)] py-20 lg:py-28">
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
            ...
            {{-- Kades --}}
            <div
                class="reveal flex flex-col sm:flex-row items-center gap-6 bg-white rounded-2xl p-6 sm:p-8 mb-10 border border-[color:var(--forest)]/10">
                <div
            ...
            <div class="reveal relative">
                <div class="overflow-hidden">
                    <div id="orgTrack" class="carousel-track flex gap-5">
                        ...
                        @foreach ($perangkat as $jabatan)
                            <div
                                class="min-w-[220px] sm:min-w-[240px] bg-white border border-[color:var(--forest)]/10 rounded-2xl p-6 text-center">
                                <div
                                    class="w-20 h-20 mx-auto rounded-full bg-[color:var(--forest)]/10 flex items-center justify-center font-display text-sm text-[color:var(--forest)] mb-4">
                                    Foto
                                </div>
                ...
                <div class="flex justify-center gap-3 mt-8">
                    <button id="orgPrev" aria-label="Sebelumnya"
                        class="w-10 h-10 rounded-full border border-[color:var(--forest)]/20 flex items-center justify-center hover:bg-[color:var(--forest)] hover:text-white transition-colors text-[color:var(--forest)]">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
                        </svg>
                    </button>
                    <button id="orgNext" aria-label="Berikutnya"
                        class="w-10 h-10 rounded-full border border-[color:var(--forest)]/20 flex items-center justify-center hover:bg-[color:var(--forest)] hover:text-white transition-colors text-[color:var(--forest)]">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            stroke-width="2">
