    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-x-auto pb-4 shadow-sm sm:rounded-lg p-6">
                ...
                <!-- Pembungkus agar tabel bisa di-scroll horizontal di HP -->
                <div class="overflow-x-auto pb-4">
                    <table class="min-w-full bg-white border whitespace-nowrap">
                        <thead>
                ...
                <div class="overflow-x-auto pb-4">
                    <table class="min-w-full bg-white border whitespace-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                <td class="py-2 px-4">
                                    <img src="{{ asset('storage/' . ($b->gambar[0] ?? 'default.jpg')) }}" class="w-20 h-16 object-cover rounded border">
                                </td>
                                <td class="py-2 px-4">
